...
class RewardConfig(TrainingArguments):
    ...
    max_length: Optional[int] = field(default=None, metadata={"help": "The maximum length of the sequences in the batch. This argument is required if you want to use the default data collator."})
    ...
    gradient_checkpointing_kwargs: Optional[dict] = field(default=None, metadata={"help": "Keyword arguments to pass to the gradient checkpointing function."})
