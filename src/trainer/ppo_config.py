...
from src.utils.utils import exact_div
...
class PPOConfig:
    ...
    kl_penalty: Literal["kl", "abs", "mse", "full", "motion"] = "kl"
    ...
    """Use default scheduler for learning rate"""
    ...
    def __post_init__(self):
        ...
        assert self.kl_penalty in ["kl", "abs", "mse", "full", "motion"]
